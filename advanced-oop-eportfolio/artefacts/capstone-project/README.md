...
The capstone brings together selected artefacts from across the module to demonstrate the application of advanced object-oriented design principles in the context of secure, maintainable, and scalable software systems. Rather than focusing on a single large application, the capstone reflects a coherent design narrative that emphasises design evolution, architectural decision-making, and the practical application of object-oriented theory.
